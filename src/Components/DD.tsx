...
//   useEffect(() => {
//     if (props.selectedOptions || selectedOptions, props.options) {
//       getTextForTextField(props.selectedOptions || selectedOptions, props.options)
//     }
//     setObjectSelectedOption(getSelectedObjects(props.selectedOptions || selectedOptions));
//   }, [props.selectedOptions, selectedOptions, getSelectedObjects, props.options])
...
//       return props.options && props.options.find((option) => option.id === id);
...
//     if (props.selectedOptions && props.onChange) {
...
//               value={value}
//               button={props.selectedOptions && (props.selectedOptions?.length > 0 || selectedOptions?.length) ? {
...
//                     props.onChangeOption && props.options && props.onChangeOption([...props.options, newOption])
//                   }
//                 }}
//               >
//                 Add New Label
...
//                     children: () => {
//                       return (
//                         props.type === "dropdown" && props.selectedOptions && (props.selectedOptions?.length > 0 || selectedOptions?.length > 0) ? (
//                           <InputDropdownIsEditingFalse simpanDropdown={value} />
//                         )
//                           : (props.type === "tags" && props.multiSelect && props.selectedOptions && (props.selectedOptions?.length > 0 || selectedOptions?.length > 0)) ? (
//                             <MultiOptionTagsIsEditingFalse selectedOptions={objectSelectedOption} />
//                           )
//                             : (props.type === "tags" && !!!props.multiSelect) && props.selectedOptions && (props.selectedOptions?.length > 0 || selectedOptions?.length > 0) ? (
//                               <OptionTags option={objectSingle} />
//                             )
//                               : (props.type === "persona" && !!!props.multiSelect && props.selectedOptions && (props.selectedOptions?.length > 0 || selectedOptions?.length > 0)) ? (
//                                 <OptionPersona option={objectSingle} />
//                               )
//                                 : (props.type === "persona" && props.multiSelect && props.selectedOptions && (props.selectedOptions?.length > 0 || selectedOptions?.length > 0)) ? (
//                                   <OptionMultiPersona partitionedItems={partitionedItems} />
